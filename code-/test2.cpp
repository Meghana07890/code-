...
int main() {
    ...
    std::vector<std::pair<double, double>> points = {
        {1, convert_to_base10("28735619723837", 10)},
        {2, convert_to_base10("1A228867F0CA", 16)},
        {3, convert_to_base10("32811A4AA0B7B", 12)},
        {4, convert_to_base10("917978721331A", 11)},
        {5, convert_to_base10("1A22886782E1", 16)},
        {6, convert_to_base10("28735619654702", 10)},
        {7, convert_to_base10("714B5070CC4B", 14)},
        {8, convert_to_base10("122662581541670", 9)},
        {9, convert_to_base10("642121030037605", 8)}
    };
    if (points.size() < 3) {
